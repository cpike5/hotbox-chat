...
namespace HotBox.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomStatus = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "RegistrationMode", "ServerName" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), 1, "HotBox" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirectMessages_SenderId_RecipientId_CreatedAt",
                table: "DirectMessages",
